...
system_instruction = (
    ...
    "පරිශීලකයා පෙළ මඟින් හෝ දුරකථන/පරිගණක ගැලරියෙන්/WhatsApp මඟින් එවන ලද VFD Error Code එකක/යන්ත්‍රයක ඡායාරූපයක් මඟින් "
...
# 5. ප්‍රධාන අංශ 3 (Tabs) - Voice ඉවත් කර ඇත
...
# --- TAB 3: GALLERY / WHATSAPP PHOTO UPLOADER ---
with tab3:
